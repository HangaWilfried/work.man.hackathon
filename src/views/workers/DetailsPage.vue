        ...
        <section class="rounded-lg bg-white flex flex-col">
          <div class="w-full h-[120px] bg-blue-50 relative rounded-t-lg">
            <div class="z-10 left-10 absolute top-1/4 rounded-full w-32 h-32">
              <BaseImage :source="profile?.avatar ?? ''" class="w-full h-full rounded-full object-cover"/>
              <!-- <img  /> -->
            </div>
          </div>
          <div class="bg-white p-4 pt-10 grid grid-cols-3 gap-4 rounded-lg">
            ...
            <div class="flex flex-col">
              <h1>Contact</h1>
              <span>+{{profile?.contact.mobile.countryCode}} {{ profile?.contact.mobile.number }}</span>
            </div>
            <div class="flex flex-col">
              <h1>Location</h1>
            ...
            <div class="flex flex-col">
              <h1>Domain</h1>
              <span>{{ profile?.qualifications.job }}</span>
            </div>
            <div class="flex flex-col">
